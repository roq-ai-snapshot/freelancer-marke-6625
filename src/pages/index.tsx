...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`freelancer marketplace like upwork`}</title>

        <meta
          name="description"
          content="Freelancer Marketplace Like Upwork - Your Ultimate Platform for Discovering Talent, Connecting Professionals, and Driving Success in Your Business Projects"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1664575196644-808978af9b1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmcmVlbGFuY2VyfGVufDB8fHx8MTY5NzY2MzUzNXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`freelancer marketplace like upwork`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Freelancer Marketplace Like Upwork - Your Ultimate Platform for Discovering Talent, Connecting Professionals, and Driving Success in Your Business Projects`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Tech Admin" type="tech-admin" abilities={appConfig.ownerAbilities} />
